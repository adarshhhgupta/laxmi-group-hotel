      ...
      <div className="feedback-container">
        ...
        <div className="feedback-cards">
          ...
          <div className="feedback-card">
            <div className="stars">★★★★★</div>
            <p>
              “Had an amazing stay here! The rooms were super clean, the staff was very polite and helpful, and the peaceful atmosphere made the trip even more special. Waking up to the fresh sea breeze and enjoying the beautiful surroundings was truly refreshing. Definitely one of the best stays in Digha. Highly recommended!”
            </p>
            <div className="feedback-user">
              <div className="avatar">P</div>
              <div>
